...
TEMPLATES = [
    {
        ...
        'DIRS':[
            ...
            os.path.join(BASE_DIR,'invoicemgmt', 'templates')
            ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Database
# https://docs.djangoproject.com/en/4.2/ref8/settings/#databases
...
DATABASES = {
    'default': dj_database_url.parse(
       "postgresql://postgres:dEAHzJvhIVKIRmKIdeXfcUKsYSsxUqzI@ballast.proxy.rlwy.net:16607/railway"
    )
}
