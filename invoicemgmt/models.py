...
def number_to_words(n, currency='USD'):
    try:
        ...
        integer_part = int(n)
        fractional_part = int(round((n - integer_part) * 100))  # Round fractional part to avoid precision issues
        ...
        return str(n)  # Fallback to numeric representation in case of errors
